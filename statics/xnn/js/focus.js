...
var focus_interval;
var focus_count;
var focus_url = "index.php?m=content&c=index&a=lists&catid=11";
var focus_title = "";
...
function focus_show(id)
{
	if(focus_time < 20 && focus_bg != "")
	{
		...
		document.getElementById("focus_show").innerHTML = "<a href='" + "index.php?m=content&c=index&a=lists&catid=11" + "' target='_self' title='" + focus_title + "'><img src='" + arr[0] + "' /></a>";
		focus_url = arr[1];
		focus_title = arr[2];
