...
function focus_show3(id)
{
	if(focus_time_three < 20 && focus_bg_three != "")
	{
		...
		document.getElementById("focus_show3").innerHTML = "<a href='" + "index.php?m=content&c=index&a=lists&catid=15" + "' target='_self' title='" + focus_title_three + "'><img src='" + arr[0] + "' /></a>";
